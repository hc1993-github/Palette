...
public class SM2Util extends GMBaseUtil {
    ...
    public static void main(String[] args) {
    	try {
	    	...
	    	String pubkhex = SM2Util.getPublicKeyHex(pair.getPublic());
	    	String prikhex = SM2Util.getPrivateKeyHex(pair.getPrivate());
	    	System.out.println("公钥 " + pubkhex);
	    	System.out.println("私钥 " + prikhex);
	    	
	    	String ming = "你好hello world +)##$%";
	    	String mi = SM2Util.encryptString(ming, pubkhex);
	    	String ming2 = SM2Util.decryptString(mi, prikhex);
