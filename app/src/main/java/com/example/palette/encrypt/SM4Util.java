...
public class SM4Util extends GMBaseUtil {
    ...
    public static String encryptString(String raw, String key) {
        try {
            return ByteUtils.toHexString(encrypt_Ecb_Padding(ByteUtils.fromHexString(key),raw.getBytes()));
            ...
            e.printStackTrace();
//            Log.d("zwf","e==="+e.toString());
            return null;
        }
    }

    public static String decryptString(String cipher, String key) {
        try {
            return new String(decrypt_Ecb_Padding(ByteUtils.fromHexString(key), ByteUtils.fromHexString(cipher)));
...
//
//			String key1 = ByteUtils.toHexString(SM4Util.generateKey());
//
//
//			System.out.println("密钥为 " + key1);
//            String key ="3f3ffe2ffb9471272c0f36534c8eb079";
//            System.out.println("key==="+key.length());
////            String substringkey = hash1;
//            String substringkey = key1;
//            System.out.println("key==="+substringkey.length());
//
//            String ming = "你好hello world +)##$%";
//			String mi = SM4Util.encryptString(ming, substringkey);
//			String ming2 = SM4Util.decryptString(mi, substringkey);
//			System.out.println("明文  " + ming + "\n加密为 " + mi + "\n解密为 " + ming2);
//	    	System.out.println(ming.equals(ming2) ? "相同":"不同");
//
