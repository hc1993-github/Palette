package com.example.palette.layoutmanager.horizontal;
...
import com.example.palette.layoutmanager.horizontal.CoverFlowLayoutManager;


public class RecyclerCoverFlowView extends RecyclerView {
    public RecyclerCoverFlowView(Context context,AttributeSet attrs) {
        super(context, attrs);
        init();
    }
